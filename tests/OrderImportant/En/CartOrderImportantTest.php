<?php
namespace App\Tests\OrderImportant\En;

use Facebook\WebDriver\WebDriverBy;
use App\Tests\EndToEnd\EndToEndTest;
use Facebook\WebDriver\WebDriverKeys;
use App\Tests\EndToEnd\En\Utils\CartTrait;
...
class CartOrderImportantTest extends EndToEndTest
{
    ...
    public function testAddProduct()
    {
        ...
        $this->addProduct('productwithoutsubcategory'); //produit-without-subcategory stock=1 50€ 
        ...
        $this->addProduct('my'); // my object stock=50 350€
    ...
    public function testGetFullCartCorrectInfosAndOrder()
    {
        ...
        $this->openCartMenu();
        $this->assertSelectorTextContains('.cart-line-wrapper:first-of-type .cart-line-title', 'productwithoutsubcategory');
        $this->assertSelectorTextContains('.cart-line-wrapper:last-of-type .cart-line-title', 'my object');
    ...
    {
        $this->addProduct('productwithoutcategory');
    ...
    public function testCartMenuContainsPurchaseButton()
    {
        ...
        $this->assertSelectorAttributeContains('.cart-footer-link', 'href', $this->urlGenerator->generate('en_purchase_create'));
    }
    ...
    public function testEmptyCartDoesntContainsPurchaseButton()
    {
        ...
        $this->client->waitForElementToContain('.cart-sub-header', 'The cart is empty');
        $this->assertSelectorTextContains('.cart-sub-header', 'The cart is empty');
    ...
    public function testAdminUpdateStockZero()
    {
        ...
        $this->addProduct('my');  // my object stock = 50
