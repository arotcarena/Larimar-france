...
class ApiUserControllerTest extends FunctionalTest
{
    ...
    public function setUp(): void 
    {
        ...
        $user->setCivility(TextConfig::CIVILITY_F) // la civilité est toujours enregistrée en français dans la base de données, c'est dans En\ApiUserController que la traduction est faite
    ...
    {
        $this->client->request('GET', $this->urlGenerator->generate('en_api_user_getCivilState'));
    ...
    {
        $this->client->request('POST', $this->urlGenerator->generate('en_api_user_setCivilState'), [], [], [], json_encode([
    ...
    {
        $this->client->request('POST', $this->urlGenerator->generate('en_api_user_setCivilState'), [], [], [], json_encode([
            'civility' => EnTextConfig::CIVILITY_M,
