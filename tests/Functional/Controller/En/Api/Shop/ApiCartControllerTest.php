...
class ApiCartControllerTest extends FunctionalTest
{
    ...
    public function testAddOverStock()
    {
        ...
        $this->assertResponseStatusCodeSame(Response::HTTP_INTERNAL_SERVER_ERROR);
        $this->assertEquals(
            EnTextConfig::ERROR_NOT_ENOUGH_STOCK,
    ...
    public function testAddQuantityResultsOverStock()
    {
        ...
        $this->assertResponseStatusCodeSame(Response::HTTP_INTERNAL_SERVER_ERROR);
        $this->assertEquals(
            EnTextConfig::ERROR_ALREADY_IN_CART,
            json_decode($this->client->getResponse()->getContent())->errors
        );
    ...
    public function testGetFullCartCountDatabaseQueries()
    {
        ...
        $this->client->enableProfiler();
        $this->client->request('GET', $this->urlGenerator->generate('en_api_cart_getFullCart'));
    ...
    public function testCount()
    {
        ...
        $this->client->request('GET', $this->urlGenerator->generate('en_api_cart_count'));
    ...
    {
        $this->client->request('GET', $this->urlGenerator->generate('en_api_cart_less', [
            'productId' => $productId,
            'quantity' => $quantity
        ])); 
    }
    ...
    {
        $this->client->request('GET', $this->urlGenerator->generate('en_api_cart_remove', [
            'productId' => $productId
        ]));
    }
    private function callAdd($productId, $quantity)
    {
        $this->client->request('GET', $this->urlGenerator->generate('en_api_cart_add', [
            'productId' => $productId,
            'quantity' => $quantity
        ]));
    }
    ...
    {
        $this->client->request('GET', $this->urlGenerator->generate('en_api_cart_getLightCart'));
        return json_decode($this->client->getResponse()->getContent());
    }
