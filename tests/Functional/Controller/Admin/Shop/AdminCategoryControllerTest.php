...
class AdminCategoryControllerTest extends AdminFunctionalTest
{
    ...
    public function testCreateValidCategoryCorrectPersist()
    {
        ...
        $this->assertEquals('test category', $persistedCategory->getEnName());
        $this->assertEquals('test-category-slug', $persistedCategory->getEnSlug());
    ...
    public function testUpdateCorrectChanges()
    {
        ...
        $this->submitForm(
            ...
            [
                ...
                'category[enName]' => 'updated category en name',
                'category[slug]' => 'updated-category',
                'category[enSlug]' => 'updated-category-en-slug',
        ...
        $this->assertEquals('updated category en name', $updatedCategory->getEnName());
        $this->assertEquals('updated-category', $updatedCategory->getSlug());
        $this->assertEquals('updated-category-en-slug', $updatedCategory->getEnSlug());
    ...
    public function testShowContainsCorrectSections()
    {
        ...
        $this->assertSelectorTextContains('.enName', $category->getEnName());
        $this->assertSelectorTextContains('.slug', $category->getSlug());
        $this->assertSelectorTextContains('.enSlug', $category->getEnSlug());
    ...
    private function createValidData(array $options = []):array
    {
        $categoryData = [
            ...
            'category[enName]' => 'new category',
            'category[slug]' => 'nouvelle-categorie',
            'category[enSlug]' => 'new-category',
