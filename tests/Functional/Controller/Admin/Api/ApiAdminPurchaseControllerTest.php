...
use App\Email\Fr\Customer\PurchaseStatusEmail;
...
class ApiAdminPurchaseControllerTest extends AdminFunctionalTest
{
    ...
    public function testUpdateStatusDontUpdateWhenStatusEmailError()
    {
        ...
        $en_purchaseStatusEmail = $this->createMock(EnPurchaseStatusEmail::class);
        ...
        $apiAdminPurchaseController = new ApiAdminPurchaseController($em, $purchaseRepository, $purchaseStatusEmail, $en_purchaseStatusEmail);
