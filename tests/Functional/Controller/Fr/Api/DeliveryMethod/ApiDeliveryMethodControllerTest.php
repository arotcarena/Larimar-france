<?php
namespace App\Tests\Functional\Controller\Fr\Api\DeliveryMethod;

use App\Tests\Functional\FrFunctionalTest;
use Symfony\Component\HttpFoundation\Response;
use App\DataFixtures\Customer\DeliveryMethodFixtures;

class ApiDeliveryMethodControllerTest extends FrFunctionalTest
{
    ...
    {
        $this->client->request('POST', $this->urlGenerator->generate('fr_api_deliveryMethod_choices'), [], [], [], json_encode([
            'count' => 1
        ]));
