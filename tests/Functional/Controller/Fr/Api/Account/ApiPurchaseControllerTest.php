 ...
 * @group FunctionalApi
 */
class ApiPurchaseControllerTest extends FrFunctionalTest
{
    use LoginUserTrait;
    ...
    {
        $this->client->request('GET', $this->urlGenerator->generate('fr_api_purchase_findPaginatedLight'));
    ...
    public function testFindOneFullWithNoIdParam()
    {
        ...
        $this->client->request('GET', $this->urlGenerator->generate('fr_api_purchase_findOneFull'));
    }
    ...
    public function testLastVerificationBeforePaymentWithEmptyCart()  // ex: si l'admin vient de supprimer le seul produit dans notre cart
    {
        ...
        $this->client->request('POST', $this->urlGenerator->generate('fr_api_purchase_lastVerificationBeforePayment', [
            'id' => $purchase->getId()
    ...
    public function testLastVerificationBeforePaymentDatabaseQueriesCount()
    {
        ...
        $this->assertLessThan(20, $dbCollector->getQueryCount(), 'dans mon premier test à 14');
    }
