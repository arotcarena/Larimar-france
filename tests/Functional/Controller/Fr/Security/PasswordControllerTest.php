 ...
 */
class PasswordControllerTest extends FrFunctionalTest
{
    ...
    {
        $this->client->request('GET', $this->urlGenerator->generate('fr_security_askResetPassword'));
    ...
    {
        $this->client->request('GET', $this->urlGenerator->generate('fr_security_resetPassword'), [
    ...
    {
        $this->client->request('GET', $this->urlGenerator->generate('fr_security_changePassword'));
        $this->assertResponseRedirects($this->urlGenerator->generate('fr_security_login'));
    }
    ...
    private function loginUserAndTryChangePassword(string $oldPassword, string $password, string $passwordConfirm)
    {
        ...
        $crawler = $this->client->request('GET', $this->urlGenerator->generate('fr_security_changePassword'));
    ...
    {
        $crawler = $this->client->request('GET', $this->urlGenerator->generate('fr_security_askResetPassword'));
        $form = $crawler->selectButton('Valider')->form([
            'email' => $email
        ]);
        $this->client->submit($form);
    ...
    private function submitPassword(string $password, string $passwordConfirm, ?User $user = null)
    {
        ...
        $crawler = $this->client->request('GET', $this->urlGenerator->generate('fr_security_resetPassword'), [
            'token' => $user->getId() . '==' . $user->getResetPasswordToken()
        ]);
        $form = $crawler->selectButton('Valider')->form([
