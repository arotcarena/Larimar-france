 ...
 */
class RegistrationControllerTest extends FrFunctionalTest
{ 
    use LoginTrait;
    ...
    {
        $this->client->request('GET', $this->urlGenerator->generate('fr_security_register'));
    ...
    {
        $this->client->request('GET', $this->urlGenerator->generate('fr_security_emailConfirmation'), [
    ...
    {
        $this->client->request('GET', $this->urlGenerator->generate('fr_security_accountDelete'));
        $this->assertResponseRedirects($this->urlGenerator->generate('fr_security_login'));
    }
    ...
    public function testAccountDeleteUserHavingPurchasesInProgressCannotAccess()
    {
        ...
        $this->client->request('GET', $this->urlGenerator->generate('fr_security_accountDelete'));
        $this->assertResponseRedirects($this->urlGenerator->generate('fr_account_index'));
        $this->client->followRedirect();
        $this->assertSelectorExists('.alert.alert-danger');
    }
    ...
    public function testAccountDeleteRender()
    {
        ...
        $this->client->request('GET', $this->urlGenerator->generate('fr_security_accountDelete'));
        $this->assertSelectorTextContains('button', 'Supprimer mon compte');
    }
    ...
    public function testAccountDeleteTryToDeleteWithoutCsrfToken()
    {
        ...
        $this->client->request('POST', $this->urlGenerator->generate('fr_security_accountDelete'));
    ...
    public function testAccountDeleteLegit()
    {
        ...
        $crawler = $this->client->request('GET', $this->urlGenerator->generate('fr_security_accountDelete'));
