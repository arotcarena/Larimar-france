...
class LoginTest extends EndToEndTest
{
    ...
    public function testRegisterLink()
    {
        ...
        $this->client->waitForElementToContain('.form-button', 'CRÉER UN COMPTE', 3);
        $this->assertSelectorTextContains('.form-button', 'CRÉER UN COMPTE');
    }
    ...
    public function testDontRememberMe()
    {
        ...
        $this->client->waitForElementToContain('.form-button', 'SE CONNECTER', 3);
        $this->assertSelectorTextContains('.form-button', 'SE CONNECTER');
    }
