<?php
namespace App\Tests\EndToEnd\En\Checkout;
...
class ApiPaymentControllerEndToEndTest extends EndToEndTest
{
    ...
    public function testCreatePaymentIntentReturnCorrectClientSecretAmountCorrespondingCartTotalPriceIfNoTotalIsPassed()
    {
        $this->addProduct('obj');
        ...
        $crawler = $this->client->request('GET', $this->urlGenerator->generate('en_api_payment_createPaymentIntent'));
