...
class AdminProductEndToEndTest extends AdminEndToEndTest
{
    ...
    public function testCreateSubCategorySelectIsCorrectlyUpdatedWhenCategoryChange()
    {
        ...
        $this->assertSelectorTextContains('#product_subCategory option:nth-child(4)', 'Bagues'); 
        $this->assertSelectorTextContains('#product_subCategory option:nth-child(5)', 'Colliers'); 
        $this->assertSelectorTextContains('#product_subCategory option:nth-child(6)', 'Pendentifs');
        $this->assertSelectorTextContains('#product_subCategory option:nth-child(7)', 'Accessoires');
        $this->assertSelectorTextContains('#product_subCategory option:nth-child(8)', ''); 
        ...
        $this->assertSelectorTextContains('#product_subCategory option:nth-child(20)', 'Décoration'); 
        $this->assertSelectorTextContains('#product_subCategory option:nth-child(21)', 'Détente'); 
        $this->assertSelectorTextContains('#product_subCategory option:nth-child(22)', ''); 
        $this->assertSelectorTextContains('#product_subCategory option:last-child', '');
    }
