...
use App\Convertor\En\CategoryToArrayConvertor;
...
class CategoryToArrayConvertorTest extends KernelTestCase
{
    ...
    {
        $category = $this->categoryRepository->findOneBy([]);
        $url = $this->urlGenerator->generate('en_category_show', [
    ...
    public function testContainsCorrectSubCategoryName()
    {
        ...
        $this->assertEquals(
            $category->getSubCategories()->get(0)->getEnName(), 
    ...
    public function testContainsCorrectSubCategoryUrl()
    {
        ...
        $url = $this->urlGenerator->generate('en_subCategory_show', [
            'categorySlug' => $category->getEnSlug(),
            'subCategorySlug' => $category->getSubCategories()->get(0)->getEnSlug()
        ]);
        $this->assertEquals(
            $url, 
