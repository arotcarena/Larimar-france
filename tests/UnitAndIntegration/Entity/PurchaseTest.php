...
class PurchaseTest extends EntityTest
{
    ...
    public function testInvalidLang()
    {
        $this->assertHasErrors(
            1,
            $this->createValidPurchase()->setLang('unkwnowlanguage')
        );
    }
    public function testValidLangEn()
    {
        $this->assertHasErrors(
            0,
            $this->createValidPurchase()->setLang('en')
        );
    }
    public function testValidLangFr()
    {
        $this->assertHasErrors(
            0,
            $this->createValidPurchase()->setLang('fr')
        );
    }
