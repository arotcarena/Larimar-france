...
class SubCategoryRepository extends ServiceEntityRepository
{
    ...
    public function findOneByBothSlugs(string $categorySlug, string $subCategorySlug): ?SubCategory
    {
    ...
    public function findOneByBothEnSlugs(string $categoryEnSlug, string $subCategoryEnSlug): ?SubCategory
    {
        return $this->createQueryBuilder('sc')
                    ->join('sc.parentCategory', 'c')
                    ->where('c.enSlug = :categoryEnSlug')
                    ->andWhere('sc.enSlug = :subCategoryEnSlug')
                    ->setParameter('categoryEnSlug', $categoryEnSlug)
                    ->setParameter('subCategoryEnSlug', $subCategoryEnSlug)
                    ->getQuery()
                    ->getOneOrNullResult()
                    ;
    }
