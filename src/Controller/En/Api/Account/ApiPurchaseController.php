...
class ApiPurchaseController extends AbstractController
{
    ...
    #[Route('/en/api/purchase/findPaginatedLight', name: 'en_api_purchase_findPaginatedLight')]
    public function findPaginatedLight(Request $request): JsonResponse
    {
        ...
        $perPage = $request->query->get('limit', 100);
    ...
    #[Route('/en/api/purchase/{id}/findOneFull', name: 'en_api_purchase_findOneFull')]
    public function findOneFull(int $id): JsonResponse
    {
        $purchase = $this->purchaseRepository->find($id);
        if(!$purchase)
        {
            throw new NotFoundResourceException('Aucune purchase avec l\'id '.$id.' - En\ApiPurchaseController line 87');
        }
        return $this->json(
    ...
    #[Route('/en/api/purchase/lastVerificationBeforePayment', name: 'en_api_purchase_lastVerificationBeforePayment', methods: ['POST'])]
