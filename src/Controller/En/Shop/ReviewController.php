...
class ReviewController extends AbstractController
{
    ...
    // #[IsGranted('ROLE_USER')]
    // #[Route('/en/leave-a-review/{productSlug}_{publicRef}.html', name: 'en_review_create', methods: ['GET', 'POST'], priority: 1)]
    ...
    //     return $this->render('en/shop/review/create.html.twig', [
    //         'product' => $product,
    //         'form' => $form->createView(),
    //         'product_show_url' => $this->productShowUrlResolver->getUrl($product, 'en')
    //     ]);
    // }
}