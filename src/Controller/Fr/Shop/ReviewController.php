...
class ReviewController extends AbstractController
{
    ...
    // #[IsGranted('ROLE_USER')]
    // #[Route('/fr/laisser-un-avis/{productSlug}_{publicRef}.html', name: 'fr_review_create', methods: ['GET', 'POST'], priority: 1)]
    ...
    //     return $this->render('fr/shop/review/create.html.twig', [
    //         'product' => $product,
