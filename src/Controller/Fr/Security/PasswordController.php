...
use App\Email\Fr\Security\ResetPasswordEmail;
...
class PasswordController extends AbstractController
{
    ...
    #[Route('/fr/mot-de-passe-oublié', name: 'fr_security_askResetPassword', methods: ['POST', 'GET'])]
    public function askResetPassword(Request $request)
    {
        ...
        return $this->render('fr/security/ask_reset_password.html.twig', [
            'error' => $error
        ]);
    }

    #[Route('/fr/réinitialiser-mon-mot-de-passe', name: 'fr_security_resetPassword')]
    public function resetPassword(Request $request): Response
    {
        ...
        return $this->render('fr/security/reset_password.html.twig', [
    ...
    #[IsGranted('ROLE_USER')]
    #[Route('/fr/changer-de-mot-de-passe', name: 'fr_security_changePassword')]
    public function changePassword(Request $request): Response 
    {
        ...
        return $this->render('fr/security/change_password.html.twig', [
            'form' => $form->createView()
        ]);
    }
}