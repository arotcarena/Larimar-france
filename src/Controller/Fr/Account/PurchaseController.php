...
use App\Email\Fr\Customer\PurchaseConfirmationEmail;
...
class PurchaseController extends AbstractController
{
    ...
    #[Route('/fr/passer-commande', name: 'fr_purchase_create')]
    public function create(): Response
    {
        ...
        return $this->render('fr/customer/purchase/create.html.twig');
    }

    #[Route('/fr/commande-validee', name: 'fr_purchase_paymentSuccess')]
    public function paymentSuccess(Request $request): Response 
    {
        ...
        $this->addFlash('success', 'Merci de votre commande. Nous avons bien reçu votre paiement d\'un montant de '.$this->priceFormater->format($paymentIntent->amount_received).'. Un email récapitulatif vous a été envoyé. Retrouvez vos commandes dans Mon compte > mes commandes');
