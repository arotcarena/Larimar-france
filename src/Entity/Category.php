...
#[UniqueEntity('enSlug', message: 'Le slug anglais doit être unique')]
...
class Category
{
    ...
    #[Assert\NotBlank(message: 'Le nom anglais de la catégorie est obligatoire')]
    #[Assert\Length(max: 200, maxMessage: '200 caractères maximum')]
    #[ORM\Column(length: 255, nullable: true)]
    private ?string $enName = null;

    #[Assert\Regex('/^[a-z0-9]+(?:-[a-z0-9]+)*$/', message: 'Slug invalide (format requis : valid-category-slug)')]
    #[Assert\NotBlank(message: 'Le slug anglais est obligatoire')]
    #[Assert\Length(max: 200, maxMessage: '200 caractères maximum')]
    #[ORM\Column(length: 255, nullable: true)]
