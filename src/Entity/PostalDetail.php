...
class PostalDetail
{
    ...
    public function setContinents(?array $continents): self
    {
    ...
    public function getEnCountry(): ?string
    {
        return $this->enCountry;
    }

    public function setEnCountry(string $enCountry): self
    {
