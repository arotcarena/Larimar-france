...
class PurchaseStatusEmail extends EmailFactory
{
    ...
    public function createPaidStatusEmail(Purchase $purchase): Email 
    {
        ...
        return (new Email())
            ...
            ->html($this->twig->render('fr/email/customer/purchaseStatus/paid_status.html.twig', [
                'purchase' => $purchase,
    ...
    public function createSentStatusEmail(Purchase $purchase): Email 
    {
        ...
        return (new Email())
            ...
            ->html($this->twig->render('fr/email/customer/purchaseStatus/sent_status.html.twig', [
                'purchase' => $purchase,
                'isAtHomeDelivery' => $isAtHomeDelivery,
            ]));
    }
    ...
    public function createDeliveredStatusEmail(Purchase $purchase): Email
    {
        ...
        return (new Email())
            ...
            ->html($this->twig->render('fr/email/customer/purchaseStatus/delivered_status.html.twig', [
                'purchase' => $purchase,
                'isAtHomeDelivery' => $isAtHomeDelivery,
            ]));
    }
    ...
    public function createCanceledStatusEmail(Purchase $purchase): Email
    {
        ...
        return (new Email())
            ...
            ->html($this->twig->render('fr/email/customer/purchaseStatus/canceled_status.html.twig', [
                'purchase' => $purchase,
                'isAtHomeDelivery' => $isAtHomeDelivery,
            ]));
