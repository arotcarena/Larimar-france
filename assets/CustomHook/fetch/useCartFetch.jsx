 ...
 * @returns 
 */
export const useCartFetch = (lang = 'fr') => {
    ...
    const fetchCart = useCallback(async () => {
        ...
        try {
            const fullCart = await apiFetch('/'+lang+'/api/cart/getFullCart');
    ...
    const remove = useCallback(async (productId) => {
        ...
        try {
            await apiFetch('/'+lang+'/api/cart/remove/id-'+productId);
        } catch(e) {
    ...
    const add = useCallback(async (productId, quantity, neededQuantity) => {
        ...
        try {
            await apiFetch('/'+lang+'/api/cart/add/id-'+productId+'_quantity-'+quantity);
        } catch(e) {
    ...
    const less = useCallback(async (productId, quantity, neededQuantity) => {
        ...
        dispatch({type: 'UPDATE_TOTAL_PRICE_AND_COUNT'});
        try {
            await apiFetch('/'+lang+'/api/cart/less/id-'+productId+'_quantity-'+quantity);
        } catch(e) {
            if(!e instanceof ApiError) {
