...
export const Purchase = ({purchase}) => {
    ...
    const handleExpandClick = async e => {
        ...
        if(!fullPurchase) {
            ...
            try {
                const full = await apiFetch('/fr/api/purchase/'+purchase.id+'/findOneFull');
    ...
    return (
        <div className="purchase-item" onClick={handleExpandClick}>
            <div className="purchase-item-row purchase-item-header">
                <span className="purchase-light-item">Commande n°{purchase.ref}</span>
            ...
            <div className="purchase-item-row purchase-item-footer">
                ...
                <span className="purchase-light-item">{purchase.status}</span>
            </div>
...
const FullPurchase = ({fullPurchase, isLoading, close}) => {
    if(isLoading) {
        ...
        return <div>Impossible d'afficher la commande complète. Veuillez réessayer ultérieurement</div>
    }
        ...
        <>
            ...
            <div className="purchase-full-item">
                ...
                <div className="purchase-separator"></div>
                {
                    ...
                    ?
                    <>
                        <div className="purchase-full-item-title">Livraison en point relais / locker</div>
                    ...
                    :
                    <>
                        <div className="purchase-full-item-title">Adresse de livraison</div>
                        <p className="capitalize">{deliveryDetail.civility} {deliveryDetail.firstName} {deliveryDetail.lastName}</p>
            ...
            <div className="purchase-separator"></div>
            <div className="purchase-full-item">
                <div className="purchase-full-item-title">Adresse de facturation</div>
                <p className="capitalize">{invoiceDetail.civility} {invoiceDetail.firstName} {invoiceDetail.lastName}</p>
            ...
            <div className="purchase-separator"></div>
            <div className="purchase-full-item">
                <div className="purchase-full-item-title">Détail de la commande</div>
            ...
            <div className="purchase-separator"></div>
            {
                tracking && (
                    <>
                        <div className="purchase-full-item">
                            <div className="purchase-full-item-title">Numéro de suivi</div>
                            <p>{tracking}</p>
                        </div>
                        <div className="purchase-separator"></div>
                    </>
