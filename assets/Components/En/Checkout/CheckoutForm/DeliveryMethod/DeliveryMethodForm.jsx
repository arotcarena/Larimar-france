...
const schema = yup.object({
    deliveryMethod: yup.number().required('Please choose from the methods offered'),
}).required();
    ...
    useEffect(() => {
        (async () => {
            if(choices === null) {
                ...
                try {
                    const {deliveryMethods, customsFeesAlert} = await apiFetch('/en/api/deliveryMethod/choices', {
                        method: 'POST',
                        body: JSON.stringify({
