...
export const Filters = ({filters, setFilters}) => {
    ...
    return (
        <div className="search-filters">
            {
                filters.q !== '' && <h1>Results for "{filters.q}"</h1>
            }
            <div className="searchbar-wrapper">
                <input type="text" className="searchbar" name="q" value={filters.q} onChange={handleChange} placeholder="Search" />
                <SearchIcon />
            </div>
            <div className="add-filters-wrapper mobile">
                ...
                {
                    addFiltersIsOpen && (
                        <CloseButton onClick={closeAddFilters} lang="en" />
                    )
                }
                {
                    addFiltersIsOpen && (
