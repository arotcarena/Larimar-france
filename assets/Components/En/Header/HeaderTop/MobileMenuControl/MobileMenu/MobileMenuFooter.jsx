...
export const MobileMenuFooter = () => {
    return (
        <div className="mobile-menu-footer">
            <a className="footer-link" href="/en/who-am-i">Who am I ?</a>
            ...
            <div className="mobile-menu-footer-social">
                <a href="https://www.facebook.com/groups/715250349390115">
                    <img className="social-icon" src="/img/icons/social/facebook.png" alt="facebook logo" />
                </a>
                <a href="https://www.instagram.com/larimarfrance/">
                    <img className="social-icon" src="/img/icons/social/instagram.png" alt="instagram logo" />
                </a>
                <a href="https://www.youtube.com/@radiomineraux5553">
                    <img className="social-icon" src="/img/icons/social/youtube.png" alt="youtube logo" />
                </a>
            </div>
            <div className="lang-choices">
                <a className="lang-choice selected" href="/">
                    <img className="flag-icon" src="/img/icons/lang/fr.png" alt="french flag" />
                </a>
                <span>/</span>
                <a className="lang-choice" href="/en">
                    <img className="flag-icon" src="/img/icons/lang/en.png" alt="United Kingdom flag" />
                </a>
            </div>
        </div>
    )
