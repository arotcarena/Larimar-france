    ...
    return (
            <li className="cart-line-wrapper" ref={cartLineRef}>
                <div className="cart-line">
                    ...
                    <Button aria-label="Supprimer" additionalClass="icon-button cart-line-remover" onClick={handleRemoveClick} title="Remove">
                        <CloseIcon />
                    </Button>
                </div>
                {
                        ...
                        <div class="confirm-remove-wrapper">
                            <div className="confirm-remove">
                                ...
                                <div className="confirm-remove-controls">
                                    <button className="confirm-remove-button yes" onClick={handleConfirmRemove}>Yes</button>
                                    <button className="confirm-remove-button no" onClick={handleCancelRemove}>No</button>
                                </div>
                            </div>
                        </div>
                    )
